...
COMPANION_INTERCEPT_CHANCE = max(0.0, min(1.0, float(_GAMEPLAY.get("companion_intercept_chance", 0.25))))
COMPANION_HEAL_THRESHOLD = max(0.0, min(1.0, float(_GAMEPLAY.get("companion_heal_threshold", 0.6))))
