...
MAX_COMPANIONS_PER_PLAYER = max(0, int(_GAMEPLAY.get("max_companions_per_player", 2)))
COMPANION_INTERCEPT_CHANCE = max(0.0, min(1.0, float(_GAMEPLAY.get("companion_intercept_chance", 0.35))))
...
COMPANION_POWER_PER_OWNER_LEVELS = max(1, int(_GAMEPLAY.get("companion_power_per_owner_levels", 2)))
COMPANION_HIT_ROLL_PER_OWNER_LEVELS = max(1, int(_GAMEPLAY.get("companion_hit_roll_per_owner_levels", 2)))
